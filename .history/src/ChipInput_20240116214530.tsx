      ...
      <div className="flex flex-col w-[80vh]">
        <div className="relative">
          {chips.map((chip) => (
            <div
              key={chip.id}
              className="bg-[#037bfc] text-white rounded-md m-[5px] pr-[30px] pl-[10px] py-[12px] cursor-pointer flex items-center absolute left-0 top-0"
          ...
          <input
            ...
            className="rounded-md w-full pl-2 py-4 pr-[60px]"
          />
        </div>
        <ul
          className={`${
