      ...
      <div className="flex flex-col w-[80vh]">
        ...
        <ul className="cursor-pointer p-[5px] m-[5px] border-white rounded-md border-[1px] border-solid flex flex-wrap">
          {filteredItems.map((item) => (
            <li className="cursor-pointer p-[5px] m-[5px] border-[1px] border-[#ddd] rounded-md hover:text-black hover:bg-white duration-300 ease-in-out" key={item} onClick={() => handleChipClick(item)}>
              {item}
            </li>
          ))}
        </ul>
