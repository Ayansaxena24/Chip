  ...
  return (
    <div className="w-screen flex justify-center items-center">
      <div className="absolute top-10">
        <img src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-icon-png-transparent-background-osteopathy-16.png" alt="google" className="w-[100px] h-[100px]" />
      </div>
