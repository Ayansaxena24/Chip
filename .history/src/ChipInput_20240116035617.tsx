  ...
  return (
    <div className="w-screen flex justify-center items-center">
      <div className="absolute top-10">
        <img src="https://play-lh.googleusercontent.com/tjzK0-TCkXB1zxkmiRr5WNGJxQy87s1RdBx10nqLbdxRIH7bPWxTkH_YiUMbYPFRfmj7=w240-h480-rw" alt="google" className="w-[100px] h-[100px]" />
      </div>
      <div className="flex flex-col w-[80vh]">
        ...
        <ul className={`${chips.length !== 5 ? "cursor-pointer p-[5px] m-[5px] border-white rounded-md border-[1px] border-solid flex flex-wrap" : ""}`}>
